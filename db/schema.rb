...
ActiveRecord::Schema.define(version: 2020_10_18_211943) do
  ...
  create_table "pet_applications", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_pet_applications_on_user_id"
  end
  ...
  create_table "reviews", force: :cascade do |t|
    ...
    t.integer "rating"
    t.string "content"
    t.string "image", default: "https://i.ibb.co/F7HmJfk/llama.jpg"
    t.bigint "shelter_id"
    t.bigint "user_id"
  ...
  add_foreign_key "pet_applications", "users"
